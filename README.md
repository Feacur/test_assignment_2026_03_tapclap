...
- Использовать [приложенный набор ассетов с макетом](https://www.figma.com/design/UJxE6kqvNCWeAqsFjNugHh/Test-task-Match-3) (необходима регистрация)
...
- Предоставить ссылку на рабочий проект в pages.github.com с поддержкой мобильного браузера
...
- https://creator-api.cocos.com/api/cocoshub/editor_version_list?lang=en
- https://download.cocos.com//CocosCreator//v2.4.15//CocosCreator_v2.4.15_20250328_win.zip
